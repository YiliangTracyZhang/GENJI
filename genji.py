...
def pipeline(args):
    ...
    intercept, ldsc_se = ggrscore(args.bfile, args.genotype, gwas_snps, args.ovp, ggr_df, args.ovpunknown, args.intercept, N2, args.h1, args.h2)
    print('Calculating genetic covariance...')
    out = calculate(ggr_df, args.h1, args.h2, intercept, ldsc_se, N2, m)
